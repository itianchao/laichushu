...
import com.laichushu.book.org.geometerplus.zlibrary.core.options.ZLColorOption;
...
public class ZLColorOptionTests2 extends ZLOptionTests {
	...
	public void test2a_6_09() {
		runTask2a("������", new ZLColor(11599619), new ZLColor(11599620),
				11599620);
	}

	public void test2a_6_10() {
		runTask2a("������", new ZLColor(11599619), new ZLColor(11599619),
				11599619);
	}
	...
	public void test2b_6_09() {
		runTask2b("������", new ZLColor(11599619), new ZLColor(11599620),
				"11599620");
	}

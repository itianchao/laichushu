...
public class MechanismListAdapter extends RecyclerView.Adapter<MechanismListAdapter.AdapterViewHodler> {
    private MechanismListActivity mActivity;
    ...
    public MechanismListAdapter(MechanismListActivity mechanismListActivity, ArrayList<MechanismListBean.DataBean> mData) {

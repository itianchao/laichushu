...
public class EditCommentListAdapter extends RecyclerView.Adapter<EditCommentListAdapter.CommentViewHolder> {
    ...
    @Override
    public EditCommentListAdapter.CommentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = UIUtil.inflate(R.layout.item_comment_connet);
        return new EditCommentListAdapter.CommentViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final EditCommentListAdapter.CommentViewHolder holder, int position) {

...
public class FindClassDocFragment extends MvpFragment2<FindClassDocPresenter> implements FindClassDocView, PullLoadMoreRecyclerView.PullLoadMoreListener, View.OnClickListener {

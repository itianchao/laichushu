 ...
 * 举报 + 书签
 */
public class TypeBookSelectWindow extends PopupWindow {
    ...
    private List<BookSelectOptionBean> mDatas;

    public TypeBookSelectWindow(Context context, List<BookSelectOptionBean> datas) {
        super(context);
    ...
    private void initView() {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                TypeBookSelectWindow.this.dismiss();
            }
        });
    }
    ...
    class SpinerListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = View.inflate(mContext, R.layout.item_book_select, null);
                holder = new ViewHolder();
                holder.selectTv = (TextView) convertView.findViewById(R.id.tv_select);
                holder.photoIv = (ImageView) convertView.findViewById(R.id.iv_photo);
            ...
            BookSelectOptionBean bean = mDatas.get(position);
            holder.selectTv.setText(bean.getName());
            GlideUitl.loadImg(mActivity,bean.getPath(),holder.photoIv);
            return convertView;
        }
    }

...
public class ServiceFindCaseAdapter extends RecyclerView.Adapter<ServiceFindCaseAdapter.WriteBookViewHolder> {
    ...
    public ServiceFindCaseAdapter(FindServerMainPageActivity mActivity, List<HomeHotModel.DataBean> mData, FindServiceMainPagePresenter mvpPresenter) {
        this.mData = mData;
    ...
    @Override
    public ServiceFindCaseAdapter.WriteBookViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = UIUtil.inflate(R.layout.item_newbook);
        return new ServiceFindCaseAdapter.WriteBookViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final ServiceFindCaseAdapter.WriteBookViewHolder holder, final int position) {

package com.laichushu.book.ui.cc.download;
...
public class DownloadService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		downloader = CCDownloadFactory.downloaderHashMap.get(title);
		if ( downloader == null){
			...
			CCDownloadFactory.downloaderHashMap.put(title, downloader);
		}
		...
		notifyIntent.putExtra("status", Downloader.DOWNLOAD);
		...
		public void handleStatus(String videoId, int status) {
			...
			case Downloader.FINISH:
				...
				Notification.Builder builder = new Notification.Builder(getApplicationContext())
						.setContentTitle("下载完成").setSmallIcon(R.drawable.ic_launcher)
...
//                notification.(getApplicationContext(), "下载完成", "文件已下载完毕", null);
				...
				sendBroadcast(intent);
				//移除完成的downloader
				CCDownloadFactory.downloaderHashMap.remove(title);
				break;
			}
		}

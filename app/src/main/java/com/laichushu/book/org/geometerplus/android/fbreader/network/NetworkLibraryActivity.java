...
import com.laichushu.book.org.fbreader.util.Boolean3;
...
import com.laichushu.book.org.geometerplus.android.fbreader.network.action.*;
import com.laichushu.book.org.geometerplus.android.fbreader.network.auth.ActivityNetworkContext;
import com.laichushu.book.org.geometerplus.android.fbreader.tree.TreeActivity;
...
import com.laichushu.book.org.geometerplus.fbreader.network.opds.OPDSCustomNetworkLink;
import com.laichushu.book.org.geometerplus.fbreader.network.tree.*;
import com.laichushu.book.org.geometerplus.fbreader.network.urlInfo.*;
import com.laichushu.book.org.geometerplus.fbreader.tree.FBTree;
...
public abstract class NetworkLibraryActivity extends TreeActivity<NetworkTree> implements ListView.OnScrollListener, NetworkLibrary.ChangeListener {
	...
	public static final String ENABLED_CATALOG_IDS_KEY = "android.org.geometerplus.android.fbreader.data.enabled_catalogs";
	public static final String DISABLED_CATALOG_IDS_KEY = "android.org.geometerplus.android.fbreader.data.disabled_catalogs";
	...
	private final BroadcastReceiver myCatalogInfoReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			final List<String> urls =
				getResultExtras(true).getStringArrayList("org.geometerplus.android.fbreader.catalog.ids");

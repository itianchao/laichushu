...
package com.laichushu.book.org.geometerplus.fbreader.network.tree;
...
public class NetworkCatalogTree extends NetworkTree {
	...
	private boolean isSingleSyncItem(NetworkItem item) {
		...
		return "org.geometerplus.android.fbreader:book:network:description".equals(((NetworkBookItem)item).Id);
	}
}

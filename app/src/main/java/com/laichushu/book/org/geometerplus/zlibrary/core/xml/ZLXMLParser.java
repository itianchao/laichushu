...
package com.laichushu.book.org.geometerplus.zlibrary.core.xml;

import com.laichushu.book.org.geometerplus.zlibrary.core.filesystem.ZLResourceFile;
import com.laichushu.book.org.geometerplus.zlibrary.core.util.ZLArrayUtils;
...
final class ZLXMLParser {
	...
	/**
	 * doit方法利用字符流类将文件转换成一个char数组。再利用for循环迭代byte数组的过程中，doit方法又反过来调用ZLX,LReaderAdapter方法

...
package com.laichushu.book.org.geometerplus.android.fbreader.config;
...
public final class ConfigShadow extends Config implements ServiceConnection {
	...
	public boolean getSpecialBooleanValue(String name, boolean defaultValue) {
		return myContext.getSharedPreferences("org.geometerplus.android.fbreader.ui", Context.MODE_PRIVATE)
			.getBoolean(name, defaultValue);
	}

	public void setSpecialBooleanValue(String name, boolean value) {
		myContext.getSharedPreferences("org.geometerplus.android.fbreader.ui", Context.MODE_PRIVATE).edit()

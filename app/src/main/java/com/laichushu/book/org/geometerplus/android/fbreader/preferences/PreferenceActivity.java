...
package com.laichushu.book.org.geometerplus.android.fbreader.preferences;
...
import com.laichushu.book.org.geometerplus.android.fbreader.network.auth.ActivityNetworkContext;
import com.laichushu.book.org.geometerplus.android.fbreader.preferences.background.BackgroundPreference;
import com.laichushu.book.org.geometerplus.android.fbreader.preferences.fileChooser.FileChooserCollection;
...
import com.laichushu.book.org.geometerplus.fbreader.fbreader.*;
import com.laichushu.book.org.geometerplus.fbreader.fbreader.options.*;
import com.laichushu.book.org.geometerplus.fbreader.network.sync.SyncData;
import com.laichushu.book.org.geometerplus.fbreader.network.sync.SyncUtil;
import com.laichushu.book.org.geometerplus.fbreader.tips.TipsManager;
import com.laichushu.book.org.geometerplus.zlibrary.core.application.ZLKeyBindings;
import com.laichushu.book.org.geometerplus.zlibrary.core.language.Language;
import com.laichushu.book.org.geometerplus.zlibrary.core.network.JsonRequest;
import com.laichushu.book.org.geometerplus.zlibrary.core.network.ZLNetworkException;
import com.laichushu.book.org.geometerplus.zlibrary.core.options.*;
import com.laichushu.book.org.geometerplus.zlibrary.core.resources.ZLResource;
import com.laichushu.book.org.geometerplus.zlibrary.text.view.style.*;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.library.ZLAndroidLibrary;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.view.ZLAndroidPaintContext;
...
public class PreferenceActivity extends ZLPreferenceActivity {
	...
	protected void init(Intent intent) {
			...
			protected void setLanguage(String code) {
				...
				if (!code.equals(languageOption.getValue())) {
					...
					startActivity(new Intent(
						Intent.ACTION_VIEW, Uri.parse("org.geometerplus.android.fbreader-action:preferences#appearance")
					));
				}
			}
		});
		...
		colorProfileScreen.setSummary(ColorProfilePreference.createTitle(resource, org.geometerplus.android.fbreader.getColorProfileName()));
		for (String key : ColorProfile.names()) {
			colorProfileScreen.addPreference(new ColorProfilePreference(
				this, org.geometerplus.android.fbreader, colorProfileScreen, key, ColorProfilePreference.createTitle(resource, key)
			));
		}
		 */

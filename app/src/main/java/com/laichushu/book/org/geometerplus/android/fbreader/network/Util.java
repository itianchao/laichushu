...
package com.laichushu.book.org.geometerplus.android.fbreader.network;
...
import com.laichushu.book.org.geometerplus.fbreader.network.authentication.NetworkAuthenticationManager;
import com.laichushu.book.org.geometerplus.fbreader.network.urlInfo.BookUrlInfo;
import com.laichushu.book.org.geometerplus.fbreader.network.urlInfo.UrlInfo;
import com.laichushu.book.org.geometerplus.zlibrary.core.network.ZLNetworkContext;
...
public abstract class Util implements UserRegistrationConstants {
	static final String AUTHORISATION_ACTION = "android.org.geometerplus.android.fbreader.action.network.AUTHORISATION";
	public static final String SIGNIN_ACTION = "android.org.geometerplus.android.fbreader.action.network.SIGNIN";
	static final String TOPUP_ACTION = "android.org.geometerplus.android.fbreader.action.network.TOPUP";
	static final String EXTRA_CATALOG_ACTION = "android.org.geometerplus.android.fbreader.action.network.EXTRA_CATALOG";

	public static final String ADD_CATALOG_ACTION = "android.org.geometerplus.android.fbreader.action.ADD_OPDS_CATALOG";
	public static final String ADD_CATALOG_URL_ACTION = "android.org.geometerplus.android.fbreader.action.ADD_OPDS_CATALOG_URL";
	public static final String EDIT_CATALOG_ACTION = "android.org.geometerplus.android.fbreader.action.EDIT_OPDS_CATALOG";
	...
	public static boolean isOurLink(String url) {
		try {
			return Uri.parse(url).getHost().endsWith(".org.geometerplus.android.fbreader.org");
		} catch (Throwable t) {
			return false;
		}
	}
	...
	public static Uri rewriteUri(Uri uri) {
		...
		if ("http".equals(uri.getScheme()) &&
			...
			if (bookId != null && !"".equals(bookId)) {
				return Uri.parse("litres-book://data.org.geometerplus.android.fbreader.org/catalogs/litres2/full.php5?id=" + bookId);
			}
		}
		return uri;
	}

...
package com.laichushu.book.org.geometerplus.android.fbreader.error;
...
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.error.ErrorUtil;
	...
	protected void onCreate(Bundle bundle) {
		...
		okButton().setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "issues@org.geometerplus.android.fbreader.org" });

...
import com.laichushu.book.org.geometerplus.android.fbreader.api.ApiListener;
import com.laichushu.book.org.geometerplus.android.fbreader.api.ApiServerImplementation;
import com.laichushu.book.org.geometerplus.android.fbreader.api.FBReaderIntents;
import com.laichushu.book.org.geometerplus.android.fbreader.api.MenuNode;
import com.laichushu.book.org.geometerplus.android.fbreader.api.PluginApi;
import com.laichushu.book.org.geometerplus.android.fbreader.dict.DictionaryUtil;
import com.laichushu.book.org.geometerplus.android.fbreader.formatPlugin.PluginUtil;
import com.laichushu.book.org.geometerplus.android.fbreader.httpd.DataService;
import com.laichushu.book.org.geometerplus.android.fbreader.libraryService.BookCollectionShadow;
import com.laichushu.book.org.geometerplus.android.fbreader.sync.SyncOperations;
import com.laichushu.book.org.geometerplus.android.fbreader.tips.TipsActivity;
import com.laichushu.book.org.geometerplus.android.util.DeviceType;
import com.laichushu.book.org.geometerplus.android.util.SearchDialogUtil;
import com.laichushu.book.org.geometerplus.android.util.UIMessageUtil;
import com.laichushu.book.org.geometerplus.android.util.UIUtil;
import com.laichushu.book.org.geometerplus.fbreader.Paths;
import com.laichushu.book.org.geometerplus.fbreader.book.Book;
import com.laichushu.book.org.geometerplus.fbreader.book.BookUtil;
import com.laichushu.book.org.geometerplus.fbreader.book.Bookmark;
import com.laichushu.book.org.geometerplus.fbreader.bookmodel.BookModel;
import com.laichushu.book.org.geometerplus.fbreader.fbreader.ActionCode;
import com.laichushu.book.org.geometerplus.fbreader.fbreader.DictionaryHighlighting;
import com.laichushu.book.org.geometerplus.fbreader.fbreader.FBReaderApp;
import com.laichushu.book.org.geometerplus.fbreader.fbreader.options.CancelMenuHelper;
import com.laichushu.book.org.geometerplus.fbreader.fbreader.options.ColorProfile;
import com.laichushu.book.org.geometerplus.fbreader.formats.ExternalFormatPlugin;
import com.laichushu.book.org.geometerplus.fbreader.formats.PluginCollection;
import com.laichushu.book.org.geometerplus.fbreader.tips.TipsManager;
import com.laichushu.book.org.geometerplus.zlibrary.core.application.ZLApplicationWindow;
import com.laichushu.book.org.geometerplus.zlibrary.core.filesystem.ZLFile;
import com.laichushu.book.org.geometerplus.zlibrary.core.library.ZLibrary;
import com.laichushu.book.org.geometerplus.zlibrary.core.options.Config;
import com.laichushu.book.org.geometerplus.zlibrary.core.resources.ZLResource;
import com.laichushu.book.org.geometerplus.zlibrary.core.view.ZLViewWidget;
import com.laichushu.book.org.geometerplus.zlibrary.text.view.ZLTextRegion;
import com.laichushu.book.org.geometerplus.zlibrary.text.view.ZLTextView;
import com.laichushu.book.R;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.error.ErrorKeys;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.library.ZLAndroidApplication;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.library.ZLAndroidLibrary;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.view.AndroidFontUtil;
import com.laichushu.book.org.geometerplus.zlibrary.ui.android.view.ZLAndroidWidget;
...
public final class FBReader extends FBReaderMainActivity implements ZLApplicationWindow {
	...
	protected void onCreate(Bundle icicle) {
		...
		//设置程序的界面，这个界面是ViewZLAndroidWidget类。我们会在第十章“epub文件处理 -- 显示”中详细分析这个类的onDraw方法。
		...
		myFBReaderApp.addAction(ActionCode.SHOW_BOOK_INFO, new ShowBookInfoAction(this, myFBReaderApp));//书籍信息
		myFBReaderApp.addAction(ActionCode.SHOW_TOC, new ShowTOCAction(this, myFBReaderApp));
		myFBReaderApp.addAction(ActionCode.SHOW_BOOKMARKS, new ShowBookmarksAction(this, myFBReaderApp));//我的书签
		myFBReaderApp.addAction(ActionCode.SHOW_NETWORK_LIBRARY, new ShowNetworkLibraryAction(this, myFBReaderApp));//在线书库
		...
		myFBReaderApp.addAction(ActionCode.SEARCH, new SearchAction(this, myFBReaderApp));//内容查找
		myFBReaderApp.addAction(ActionCode.SHARE_BOOK, new ShareBookAction(this, myFBReaderApp));//共享书籍

		myFBReaderApp.addAction(ActionCode.SELECTION_SHOW_PANEL, new SelectionShowPanelAction(this, myFBReaderApp));//显示面板
		myFBReaderApp.addAction(ActionCode.SELECTION_HIDE_PANEL, new SelectionHidePanelAction(this, myFBReaderApp));//隐藏面板
		myFBReaderApp.addAction(ActionCode.SELECTION_COPY_TO_CLIPBOARD, new SelectionCopyAction(this, myFBReaderApp));//复制
		myFBReaderApp.addAction(ActionCode.SELECTION_SHARE, new SelectionShareAction(this, myFBReaderApp));//选择分享
		myFBReaderApp.addAction(ActionCode.SELECTION_TRANSLATE, new SelectionTranslateAction(this, myFBReaderApp));//选择间距
		myFBReaderApp.addAction(ActionCode.SELECTION_BOOKMARK, new SelectionBookmarkAction(this, myFBReaderApp));//选择书签
		...
		myFBReaderApp.addAction(ActionCode.OPEN_START_SCREEN, new StartScreenAction(this, myFBReaderApp));//开始屏幕

		myFBReaderApp.addAction(ActionCode.SET_SCREEN_ORIENTATION_SYSTEM, new SetScreenOrientationAction(this, myFBReaderApp, ZLibrary.SCREEN_ORIENTATION_SYSTEM));//系统默认
		myFBReaderApp.addAction(ActionCode.SET_SCREEN_ORIENTATION_SENSOR, new SetScreenOrientationAction(this, myFBReaderApp, ZLibrary.SCREEN_ORIENTATION_SENSOR));//传感器
		myFBReaderApp.addAction(ActionCode.SET_SCREEN_ORIENTATION_PORTRAIT, new SetScreenOrientationAction(this, myFBReaderApp, ZLibrary.SCREEN_ORIENTATION_PORTRAIT));//设置竖屏
		myFBReaderApp.addAction(ActionCode.SET_SCREEN_ORIENTATION_LANDSCAPE, new SetScreenOrientationAction(this, myFBReaderApp, ZLibrary.SCREEN_ORIENTATION_LANDSCAPE));//设置横屏
		if (getZLibrary().supportsAllOrientations()) {
			myFBReaderApp.addAction(ActionCode.SET_SCREEN_ORIENTATION_REVERSE_PORTRAIT, new SetScreenOrientationAction(this, myFBReaderApp, ZLibrary.SCREEN_ORIENTATION_REVERSE_PORTRAIT));//设置反向竖屏
			myFBReaderApp.addAction(ActionCode.SET_SCREEN_ORIENTATION_REVERSE_LANDSCAPE, new SetScreenOrientationAction(this, myFBReaderApp, ZLibrary.SCREEN_ORIENTATION_REVERSE_LANDSCAPE));//设置反向横屏
		}
		myFBReaderApp.addAction(ActionCode.OPEN_WEB_HELP, new OpenWebHelpAction(this, myFBReaderApp));//打开网络帮助
		myFBReaderApp.addAction(ActionCode.INSTALL_PLUGINS, new InstallPluginsAction(this, myFBReaderApp));//安装插件

		myFBReaderApp.addAction(ActionCode.SWITCH_TO_DAY_PROFILE, new SwitchProfileAction(this, myFBReaderApp, ColorProfile.DAY));//白天模式
		myFBReaderApp.addAction(ActionCode.SWITCH_TO_NIGHT_PROFILE, new SwitchProfileAction(this, myFBReaderApp, ColorProfile.NIGHT));//夜间模式
	...
	protected void onNewIntent(final Intent intent) {
		...
		if ((intent.getFlags() & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) != 0) {
			super.onNewIntent(intent);
				   ...
				   && data != null && "org.geometerplus.android.fbreader-action".equals(data.getScheme())) {

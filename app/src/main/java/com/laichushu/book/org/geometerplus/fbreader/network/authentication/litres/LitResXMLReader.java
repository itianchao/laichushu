...
package com.laichushu.book.org.geometerplus.fbreader.network.authentication.litres;

import com.laichushu.book.org.geometerplus.fbreader.network.NetworkBookItem;
import com.laichushu.book.org.geometerplus.fbreader.network.NetworkLibrary;
import com.laichushu.book.org.geometerplus.fbreader.network.atom.FormattedBuffer;
import com.laichushu.book.org.geometerplus.fbreader.network.opds.OPDSBookItem;
import com.laichushu.book.org.geometerplus.fbreader.network.opds.OPDSNetworkLink;
...
import com.laichushu.book.org.geometerplus.zlibrary.core.xml.*;
			...
			case BOOK:
				if (TAG_BOOK == tag) {
					myUrls.addInfo(new UrlInfo(
						...
						"http://data.org.geometerplus.android.fbreader.org/catalogs/litres2/full.php5?id=" + myBookId,

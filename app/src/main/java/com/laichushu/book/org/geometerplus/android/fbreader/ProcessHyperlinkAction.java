...
import com.laichushu.book.org.geometerplus.android.fbreader.image.ImageViewActivity;
import com.laichushu.book.org.geometerplus.android.fbreader.network.*;
...
import com.laichushu.book.org.geometerplus.fbreader.util.AutoTextSnippet;
...
class ProcessHyperlinkAction extends FBAndroidAction {
	...
	private void openInBrowser(final String url) {
		...
		new Thread(new Runnable() {
			public void run() {
				if (!url.startsWith("org.geometerplus.android.fbreader-action:")) {
					try {

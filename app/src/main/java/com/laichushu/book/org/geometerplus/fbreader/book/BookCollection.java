...
package com.laichushu.book.org.geometerplus.fbreader.book;
...
import com.laichushu.book.org.geometerplus.zlibrary.core.util.MiscUtil;
...
public class BookCollection extends AbstractBookCollection<DbBook> {
	...
	public BookCollection(SystemInfo systemInfo, BooksDatabase db, List<String> bookDirectories) {
		...
		PluginCollection = com.laichushu.book.org.geometerplus.fbreader.formats.PluginCollection.Instance(systemInfo);
		myDatabase = db;

...
import com.laichushu.book.org.geometerplus.android.fbreader.*;
...
import com.laichushu.book.org.geometerplus.fbreader.library.*;
import com.laichushu.book.org.geometerplus.fbreader.tree.FBTree;
import com.laichushu.book.org.geometerplus.zlibrary.core.options.ZLStringOption;
...
public class LibraryActivity extends TreeActivity<LibraryTree> implements MenuItem.OnMenuItemClickListener, View.OnCreateContextMenuListener, IBookCollection.Listener<Book> {
	static final String START_SEARCH_ACTION = "action.org.geometerplus.android.fbreader.library.start-search";
	...
	private void runOrInstallExternalView(boolean install) {
		try {
			...
			if (install) {
				PackageUtil.installFromMarket(this, "org.org.geometerplus.android.fbreader.plugin.library");
			}
		}
	}

...
public class SelectionColor3Action extends FBAndroidAction {

	private FBReader baseApplication;
	private Bookmark bookmark;
	private final BookCollectionShadow myCollection = new BookCollectionShadow();

	SelectionColor3Action(FBReader baseApplication, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		changeColor(Color.parseColor("#F57200"),3);

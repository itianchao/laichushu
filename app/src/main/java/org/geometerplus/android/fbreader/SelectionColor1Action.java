...
public class SelectionColor1Action extends FBAndroidAction {

	private FBReader baseApplication;
	private Bookmark bookmark;
	private final BookCollectionShadow myCollection = new BookCollectionShadow();

	SelectionColor1Action(FBReader baseApplication, FBReaderApp fbreader) {
	...
	protected void run(Object ... params) {
		...
		changeColor(Color.parseColor("#5BA8F6"),1);

...
public class SettingProgressWindow extends LinearLayout {
    public SettingProgressWindow(Context context) {
        super(context);
    ...
    public SettingProgressWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            initAnimator();
        }
    ...
    public SettingProgressWindow(Context context, AttributeSet attrs, int defStyleAttr) {

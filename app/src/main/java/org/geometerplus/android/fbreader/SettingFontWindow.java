...
public class SettingFontWindow extends LinearLayout {
    public SettingFontWindow(Context context) {
        super(context);
    ...
    public SettingFontWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            initAnimator();
        }
    ...
    public SettingFontWindow(Context context, AttributeSet attrs, int defStyleAttr) {

...
public class SettingModleWindow extends LinearLayout {
    public SettingModleWindow(Context context) {
        super(context);
    ...
    public SettingModleWindow(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            initAnimator();
        }
    ...
    public SettingModleWindow(Context context, AttributeSet attrs, int defStyleAttr) {
